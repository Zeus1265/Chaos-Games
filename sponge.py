...
T = []
T.append(lambda x, y : (x/3, y/3))
T.append(lambda x, y : ((x+1200)/3, y/3))
T.append(lambda x, y : ((x+2*1200)/3, y/3))
T.append(lambda x, y : (x/3, (y+700)/3))
T.append(lambda x, y : ((x+2*1200)/3, (y+700)/3))
T.append(lambda x, y : ((x)/3, (y+2*700)/3))
T.append(lambda x, y : ((x+1200)/3, (y+2*700)/3))
T.append(lambda x, y : ((x+2*1200)/3, (y+2*700)/3))
